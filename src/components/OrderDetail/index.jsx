...
import { removeItem , DECREASE_QUANTITY, INCREASE_QUANTITY} from "../../redux/CardBook/cardItemSlice";

const OrderDetail = () => {
  const bookItem = useSelector((state) => state.BookCard.Carts);
        ...
        <div className="container">
              ...
              <div className="order-detail__card-inner">
                ...
                <div className="order-detail__content">
                  ...
                  <div className="order-detail__content-group-input">
                    <button className="prev" onClick={() => dispatch(INCREASE_QUANTITY(item)) }>
                      <img
                        src="https://frontend.tikicdn.com/_desktop-next/static/img/pdp_revamp_v2/icons-remove.svg"
                        alt="icon prev"
                      />
                    </button>
                    <input type="text" defaultValue={item.quantity} onChange={(e) => e}/>
                    <button className="next" onClick={() => dispatch(DECREASE_QUANTITY(item))}>
                      <img
                ...
                <div className="icon-delete" onClick={() => dispatch(removeItem(item))}>
          ...
          <div className="order-detail__pay">
            ...
            <div className="order-detail__pay-transport-fee flex">
              <span> Phí vận chuyển  <img src={ImageIcon} alt="" /></span>
